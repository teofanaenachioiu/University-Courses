...
import repository.StudentRepoXML;
...
class StudentRepoXMLTest {
    private CrudRepository<String, Student> repo=new StudentRepoXML("./src/teste/Studenti.xml", new ValidatorStudent());
