...
import tasks.repository.ICrudRepository;
import tasks.utils.*;
...
public class TaskService implements Observable<SortingTaskEvent> {
    private ICrudRepository<Integer, SortingTask> repo;
    private ObservableTaskRunner runner;
    public TaskService(ICrudRepository<Integer, SortingTask> repo){

        this.repo=repo;
    }
    @Autowired
    public TaskService(ICrudRepository<Integer, SortingTask> repo, ObservableTaskRunner runner){
