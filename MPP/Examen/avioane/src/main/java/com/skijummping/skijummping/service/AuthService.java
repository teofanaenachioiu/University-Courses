...
public class AuthService {
    ...
    public Utilizator login(Utilizator utilizator) throws Exception {
        ...
        if(optional.isPresent()){
            ...
            this.utilizatorRepository.updateUtilizatorConnection(utilizator.getUsername(),true);
    ...
    public void logout(Utilizator utilizator) throws Exception {
        ...
        this.utilizatorRepository.updateUtilizatorConnection(utilizator.getUsername(),false);
    }
}
