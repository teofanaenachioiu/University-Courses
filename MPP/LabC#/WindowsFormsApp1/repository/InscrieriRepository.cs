...
namespace Concurs.repository
{
    public class InscrieriRepository : IRepositoryInscrieri
    {
        ...
        public IEnumerable<Inscriere> FindProbeDupaParticipant(int id)
        {
            IDbConnection con = DBUtils.getConnection(props);
        ...
        public IEnumerable<Participant> CautaParticipantiDupaCategorie(string categorie)
        {
            IDbConnection con = DBUtils.getConnection(props);
        ...
        public IEnumerable<Participant> cautaParticipantiDupaProba(string proba)
        {
            IDbConnection con = DBUtils.getConnection(props);
        ...
        public IEnumerable<Participant> CautaParticipantDupaProbaCategorie(string proba, string categorie)
        {
            IDbConnection con = DBUtils.getConnection(props);
