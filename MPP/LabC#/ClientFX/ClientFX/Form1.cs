...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form 
    {
        ...
        private void buttonConectare_Click(object sender, EventArgs e)
        {
            ...
            /*bool valid = controller.VerificareParola(username, password);
            if (valid)
            {
        ...
        private void PopulateGridStatistici()
        {
            ...
            /*foreach (Proba proba in controller.ListaProbe())
            {
                ...
                row["Nr Participanti"] = controller.NrParticipantiProba(proba);
        ...
        {
            //comboBoxProba.DataSource = controller.ListaProbeNume();
        }

        private void PopulateComboCategorii()
        {
            //comboBoxCategorie.DataSource = controller.ListaCategorii();
        }
